"""StdMgtSystem URL Configuration
...
urlpatterns = [
                  ...
                  path('student_feedback_msg', HodViews.student_feedback_msg, name="student_feedback_msg"),
                  path('student_feedback_msg_replied', HodViews.student_feedback_msg_replied, name="student_feedback_msg_replied"),
                  path('staff_feedback_msg', HodViews.staff_feedback_msg, name="staff_feedback_msg"),
                  path('staff_feedback_msg_replied', HodViews.staff_feedback_msg_replied, name="staff_feedback_msg_replied"),
